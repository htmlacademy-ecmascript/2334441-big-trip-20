  ...
  <form class="event event--edit" action="#" method="post">
    ...
    <section class="event__details">
      <section class="event__section  event__section--destination">
        ...
        <p class="event__destination-description">${point.destination} is a city in Switzerland that lies at the southern tip of expansive Lac Léman (Lake Geneva). Surrounded by the Alps and Jura mountains, the city has views of dramatic Mont Blanc.</p>
